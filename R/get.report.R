...
#' report <- get.report(cid, auth, name, fields, date = "LAST_14_DAYS")
get.report <- function(cid, auth, name = "ACCOUNT_PERFORMANCE_REPORT", fields = c("AccountDescriptiveName", "Impressions", "Clicks", "Cost", "Date"), date = "LAST_14_DAYS", ...)
{
